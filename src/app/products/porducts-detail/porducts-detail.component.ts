...
export class PorductsDetailComponent {
     ...
     constructor(private route : ActivatedRoute){
       ...
       this.route.params.subscribe(ramp => {
        console.log(ramp['id'])
        console.log(ramp['category'])
        this.singlePorduct = this.products.find(el => el.id == ramp['id'])
        this.filtrerdeProduct = this.products.filter(el => el.category == ramp['category'])
    ...
    filtrerdeProduct : Product[] = []

  singlePorduct? : Product = new Product
